...
namespace Parasale.Data.Migrations
{
    ...
    [Migration("20200129092834_VoiceOnBoardingSubSteps")]
    partial class VoiceOnBoardingSubSteps
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Parasale.Models.VoiceOnBoardingSubSteps", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.Property<int?>("VoiceOnBoardingId");

                    b.HasKey("Id");

                    b.HasIndex("VoiceOnBoardingId");

                    b.ToTable("VoiceOnBoardingSubSteps");
                });
            ...
            modelBuilder.Entity("Parasale.Models.VoiceOnBoardingSubSteps", b =>
                {
                    b.HasOne("Parasale.Models.VoiceOnBoarding", "VoiceOnBoarding")
                        .WithMany("voiceOnBoardingSubSteps")
                        .HasForeignKey("VoiceOnBoardingId");
                });
